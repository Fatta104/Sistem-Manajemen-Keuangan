          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo">
                  <h3 class="text-center text-primary mb-1">Sistem Manajemen Keuangan || yolo-team1</h3>
                  <div class="text-center"><small class="text-muted font-weight-bold">Login</small></div>
              </div>
               <?php 
              ...
              <form class="pt-3" action="<?php echo base_url() ?>Users/login" method="post">
                ...
                <div class="mt-3">
                    <input type="submit" name="loginSubmit" value="Login" class="btn btn-block btn-gradient-info rounded-0 btn-lg font-weight-medium auth-form-btn">
                </div>
              </form>
            </div>
          </div>
