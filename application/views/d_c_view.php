        ...
        <div class="content-wrapper">
                ...
                <div class="col-12 grid-margin">
                    <div class="card rounded-0">
                      <div class="card-header rounded-0 bg-gradient-primary">
                        <h5 class="card-title text-white mb-0">Profil Customer</h5>
                      </div>
                            ...
                            <div class="table-responsive">
                                <div class="tab">
                                    <button class="tablinkss " onclick="openCityy(event, 'debit')"
                                        id="defaultOpen">Pengeluaran</button>
                                    <button class="tablinkss " onclick="openCityy(event, 'credit')">Jumlah Diterima</button>
                                </div>
                                    ...
                                    <table id="example" class="table  table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-2 py-3 align-middle"><label class="badge badge-gradient-danger">Pengeluaran</label></td>
                                                <td class="px-2 py-3 align-middle text-right">Rp.
                                    ...
                                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-3 py-2 align-middle"><label class="badge badge-gradient-success">Jumlah Diterima</label></td>
           ...
           <div class="row mx-0">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <h5 class="text-primary">Total Pengeluaran: Rp. <?php echo number_format($row->dtotal, 2) ?></h5>
              <h5 class="text-primary">Total Jumlah Diterima: Rp. <?php echo number_format($row->ctotal, 2) ?></h5>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <h5 class="text-danger">Jatuh Tempo:  Rp. <?php echo $sum_text?></h5>
              <h5 class="text-info">Jumlah Lebihan:  Rp. <?php echo $sum_texte?></h5>
            </div>
           </div>
